...
function successConsole (projectName) {
    ...
    console.log(chalk.magenta(' vue模板:npm run serve'))
    console.log(chalk.magenta(' electron-vue模板:npm run electron:serve'))
    console.log(chalk.magenta(' react-native模板:执行相关操作'))
}
